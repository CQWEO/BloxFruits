...
_G.DistanceMob = 20
Setting:Slider("Farm Distance",1,60,20,function(value)
 ...
 game:GetService("RunService").Heartbeat:Connect(function() CheckQuest()
  pcall(function()
   ...
   sethiddenproperty(game.Players.LocalPlayer, "SimulationRadius", math.huge)
		...
		Setting:Toggle("Super Fast Attack [Kickable]", false, function(value)
		...
		Setting:Toggle("Fast Attack [Safe]",true,function(value)
			_G.FastAttack = value
		   end)
		   ...
		   Setting:Toggle("HYPER FAST ATTACK [KICKABLE]", false, function(value)
